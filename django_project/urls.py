...
from django_application.views import index, list_persons, PersonaRetrieveView, PersonaList, PersonaDetail, PersonaUpdate, PersonaDelete, PersonCreateView
...
urlpatterns = [
    ...
    path('api/personas/<int:_pk>/', PersonaDetail.as_view(), name='personas_detail'),
    ...
    path('personas/', list_persons, name='list_persons'),
]
